...
<h1 style="text-align: center; background-color: black;color: azure ; border: 5px; box-shadow: 3px 4px  lightgray; padding: 10px;font-family: sans-serif;">Customer Details Form</h1>
        
			<div class="design">
			<form action = "result.jsp">
			<h2>Enter Order ID for Customer Details</h2>
			<label>OrderID:</label>
